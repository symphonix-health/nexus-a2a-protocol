"""Matrix-driven HelixCare tests -- helixcare_diagnosis_imaging_matrix.json
...
MATRIX = "helixcare_diagnosis_imaging_matrix.json"
...
@pytest.mark.asyncio
async def test_helixcare_dx_imaging_positive(scenario: dict, client: httpx.AsyncClient, auth_headers: dict):
    sr = ScenarioResult(
...
@pytest.mark.asyncio
async def test_helixcare_dx_imaging_negative(scenario: dict, client: httpx.AsyncClient, auth_headers: dict):
    sr = ScenarioResult(
        use_case_id=scenario["use_case_id"],
        scenario_title=scenario["scenario_title"],
        poc_demo=scenario["poc_demo"],
