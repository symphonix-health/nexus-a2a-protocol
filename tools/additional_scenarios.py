        ...
        journey_steps=[
            ...
            },
            {
                ...
                "handoff_policy": {
                    ...
                    "escalation_path": ["care_coordinator", "hitl_ui"],
                    "max_wait_seconds": 1800,
                    "safe_fallback_branch": None,
            ...
            journey_steps=[
                {
                    ...
                    "handoff_policy": {
                        ...
                        "optional_predecessors": [],
                        "required_context_keys": [],
                        "required_handover_fields": ["request_type", "service", "clinical_justification"],
                        "escalation_path": ["care_coordinator", "hitl_ui"],
                        "max_wait_seconds": 1800,
                        "safe_fallback_branch": None,
                        "guideline_refs": ["CMS-PA-Requirements", "NCQA-UM-Standards"],
                    },
                },
                {
            ...
            journey_steps=[
                {
                    ...
                    "params": {
                        ...
                        "care_transition": {
                            ...
                            "receiving_team": "billing_and_finance_team",
                            "followup_responsibility": "billing_team",
                            "receiving_provider_notified": True,
                            "handover": {
                                "situation": "Patient discharged after inpatient heart failure management.",
                                "background": "Acute on chronic heart failure; responded to IV diuresis.",
                                "assessment": "Stable for discharge; billing workflow initiated.",
                                "recommendation": "Submit FHIR Claim and process 835 remittance.",
                                "plan": "Billing team to complete claim submission and reconcile remittance.",
                                "outstanding_tasks": ["Confirm claim submission", "Reconcile 835 remittance"],
                                "communication_needs": "No specific communication barriers documented.",
                            },
                        },
                    },
                    "delay": 1,
                    "handoff_policy": {
                        ...
                        "optional_predecessors": [],
                        "required_context_keys": [],
                        "required_handover_fields": ["discharge_diagnosis", "discharge_disposition"],
                        "escalation_path": ["care_coordinator", "hitl_ui"],
                        "max_wait_seconds": 3600,
                        "safe_fallback_branch": None,
                        "guideline_refs": ["CMS-Billing-Guidelines", "HIPAA-837-835-Standards"],
                    },
                },
                {
                    "agent": "profile_registry",
            ...
            journey_steps=[
                ...
                },
                {
                    ...
                    "params": {
                        ...
                        "care_transition": {
                            "handover_owner": "discharging_clinician",
                            "receiving_team": "coordinated_care_team",
                            "followup_responsibility": "primary_care_team",
                            "receiving_provider_notified": True,
                            "handover": {
                                "situation": "Care transition initiated.",
                                "background": "Relevant history shared with receiving team.",
                                "assessment": "Clinical assessment documented.",
                                "recommendation": "Proceed with receiving-team plan.",
                                "plan": "Follow local pathway and monitor response.",
                                "outstanding_tasks": ["Confirm plan ownership"],
                                "communication_needs": "No specific communication barriers documented.",
                            },
                        }
                    },
            ...
            journey_steps=[
                {
                    ...
                    "params": {
                        ...
                        "care_transition": {
                            "handover_owner": "discharging_clinician",
                            "receiving_team": "pharmacy_followup_team",
                            "followup_responsibility": "primary_care_team",
                            "receiving_provider_notified": True,
                            "handover": {
                                "situation": "Transition initiated for followup step.",
                                "background": "Relevant history shared with receiving team.",
                                "assessment": "Clinical assessment documented.",
                                "recommendation": "Proceed with receiving-team plan.",
                                "plan": "Follow local pathway and monitor response.",
            ...
            journey_steps=[
                {
                    ...
                    "params": {
                        ...
                        "care_transition": {
                            ...
                            "receiving_provider_notified": True,
                            "handover": {
                                "situation": "Transition initiated for discharge step.",
                                "background": "Relevant history shared with receiving team.",
                                "assessment": "Clinical assessment documented.",
                                "recommendation": "Proceed with receiving-team plan.",
                                "plan": "Follow local pathway and monitor response.",
            ...
            journey_steps=[
                {
                    ...
                    "params": {
                        ...
                        "care_transition": {
                            "handover_owner": "discharging_clinician",
                            "receiving_team": "hie_receiving_team",
                            "followup_responsibility": "community_care_team",
                            "receiving_provider_notified": True,
                            "handover": {
                                "situation": "Transition initiated for discharge step.",
                                "background": "Relevant history shared with receiving team.",
