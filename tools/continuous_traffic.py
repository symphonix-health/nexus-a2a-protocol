...
COMPLAINTS = [
    ...
    "bleeding", "burns", "fracture", "dehydration"
]
...
async def main():
    ...
    print(f"⏱️  Interval: 3 seconds between batches")
    print(f"🎯 Target: Generate visible dashboard metrics\n")
    ...
    try:
        while batches < 100:  # Run 100 batches (500 tasks total over ~5 minutes)
            ...
            print(f"Batch {batches:3d} | Sent: {total_sent:4d} | Success: {total_success:4d} ({rate:.1f}%)")
